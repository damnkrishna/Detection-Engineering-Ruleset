# 50f3bf00-e552-4dab-a402-9b891308bc44 — golden replay datasets

`Supply Chain Tampering - Suspicious Process Spawned by Development Tool via CLI (AN0021-A)`
...
| `benign_2.jsonl` | 0 | near-miss value for 'parent_image regex .*\Q\node.exe\E$' — every other condition holds, so the stage gate rejects the events |
