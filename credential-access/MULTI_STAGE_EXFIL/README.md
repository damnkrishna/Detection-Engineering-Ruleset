# MULTI_STAGE_EXFIL — golden replay datasets

`Credential access → collection → staging (optional) → exfiltration (Splunk: Cloud/Multi-stage Exfil story)`
...
| `true_positive_1.jsonl` | 1 | SEQUENCE: stage 0 × 1 event(s) → stage 1 × 1 event(s) → stage 2 × 1 event(s) → stage 3 × 1 event(s) → stage 4 × 1 event(s) |
| `true_positive_2.jsonl` | 1 | SEQUENCE: stage 0 × 1 event(s) → stage 1 × 1 event(s) → stage 2 × 1 event(s) → stage 3 × 1 event(s) → stage 4 × 1 event(s) |
