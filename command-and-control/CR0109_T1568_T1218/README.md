# CR0109_T1568_T1218 — golden replay datasets

`Dynamic DNS Domain Request followed by certutil Download`
...
| `benign_1.jsonl` | 0 | near-miss value for 'signature_name contains Dynamic DNS query' — every other condition holds, so the stage gate rejects the events |
