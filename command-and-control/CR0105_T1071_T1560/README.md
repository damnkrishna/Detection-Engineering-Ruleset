# CR0105_T1071_T1560 — golden replay datasets

`Anomalous HTTP POST/GET Ratio followed by File Staging`
...
| `benign_1.jsonl` | 0 | near-miss value for 'signature_name contains High HTTP POST ratio' — every other condition holds, so the stage gate rejects the events |
