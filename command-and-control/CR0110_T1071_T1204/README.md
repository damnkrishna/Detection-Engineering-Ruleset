# CR0110_T1071_T1204 — golden replay datasets

`SMTP/IMAP Traffic from Non-Mail Client Binary`
...
| `benign_1.jsonl` | 0 | near-miss value for 'signature_name contains SMTP connection outbound' — every other condition holds, so the stage gate rejects the events |
