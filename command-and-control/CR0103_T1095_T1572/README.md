# CR0103_T1095_T1572 — golden replay datasets

`Non-Standard Outbound Port Traffic followed by Local Port Forwarding`
...
| `benign_1.jsonl` | 0 | near-miss value for 'signature_name contains Outbound connection on non-standard port' — every other condition holds, so the stage gate rejects the events |
