# CR0112_T1205_T1021 — golden replay datasets

`Port Knocking Sequence followed by SMB Share Access`
...
| `benign_1.jsonl` | 0 | near-miss value for 'signature_name contains Port knocking sequence' — every other condition holds, so the stage gate rejects the events |
