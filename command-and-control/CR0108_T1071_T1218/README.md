# CR0108_T1071_T1218 — golden replay datasets

`Cobalt Strike Malleable Profile HTTP Request Match`
...
| `benign_1.jsonl` | 0 | near-miss value for 'signature_name contains Cobalt Strike HTTP request' — every other condition holds, so the stage gate rejects the events |
