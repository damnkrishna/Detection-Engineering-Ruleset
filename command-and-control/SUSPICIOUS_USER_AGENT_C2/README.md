# SUSPICIOUS_USER_AGENT_C2 — golden replay datasets

`Known malware/C2 framework or scanner user agent detected (Splunk: Suspicious User Agents story)`
...
| `benign_1.jsonl` | 0 | near-miss value for 'signature_name contains r00ts3c' — every other condition holds, so the stage gate rejects the events |
