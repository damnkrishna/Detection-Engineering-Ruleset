# COBALT_STRIKE_BEACON — golden replay datasets

`Cobalt Strike beacon signature or post-exploitation framework indicator (Splunk: Cobalt Strike story)`
...
| `benign_1.jsonl` | 0 | near-miss value for 'signature_name contains cobalt strike' — every other condition holds, so the stage gate rejects the events |
