# ZEEK_DGA_HIDS_LOLBIN — golden replay datasets

`Cross-sensor: Zeek detects DGA/NXDOMAIN burst (behavior-driven) + HIDS detects LOLBin execution on same host — confirms active implant communicating out, not scanning noise (T1568.002 + T1218)`
...
| `true_positive_1.jsonl` | 1 | SEQUENCE: stage 0 × 10 event(s) → stage 1 × 1 event(s) |
| `true_positive_2.jsonl` | 1 | SEQUENCE: stage 0 × 10 event(s) → stage 1 × 1 event(s) |
