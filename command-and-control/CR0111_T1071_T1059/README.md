# CR0111_T1071_T1059 — golden replay datasets

`IRC Protocol Outbound followed by PowerShell IEX Execution`
...
| `benign_1.jsonl` | 0 | near-miss value for 'signature_name contains IRC connection established' — every other condition holds, so the stage gate rejects the events |
