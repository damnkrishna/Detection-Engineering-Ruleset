# brute-force-then-success-001 — golden replay datasets
...
|---|---|---|
| `true_positive_1.jsonl` | 1 | SEQUENCE: stage 0 × 6 event(s) → stage 1 × 1 event(s) |
| `true_positive_2.jsonl` | 1 | SEQUENCE: stage 0 × 6 event(s) → stage 1 × 1 event(s) |
