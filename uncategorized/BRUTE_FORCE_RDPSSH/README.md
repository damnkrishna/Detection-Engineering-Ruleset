# BRUTE_FORCE_RDPSSH — golden replay datasets

`Brute force against RDP/SSH/VPN followed by successful authentication`
...
| `true_positive_1.jsonl` | 1 | SEQUENCE: stage 0 × 3 event(s) → stage 1 × 1 event(s) |
| `true_positive_2.jsonl` | 1 | SEQUENCE: stage 0 × 3 event(s) → stage 1 × 1 event(s) |
