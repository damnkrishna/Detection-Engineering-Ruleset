# APPLOCKER_BYPASS_EXEC — golden replay datasets

`AppLocker or WDAC bypass via signed binary proxy (T1218) followed by malicious execution — whitelisting evasion chain`
