# ZEEK_LARGE_TRANSFER_HIDS_COLLECTION — golden replay datasets

`Cross-sensor: HIDS detects file collection activity + Zeek detects large outbound flow from same host — data exfiltration confirmed by two independent sources`
