# PPID_SPOOF_EXEC — golden replay datasets

`Process spawned with spoofed parent PID to masquerade as legitimate child — EDR/behavioral bypass used by Cobalt Strike, custom loaders, and PPID injection tooling (T1134.004)`
