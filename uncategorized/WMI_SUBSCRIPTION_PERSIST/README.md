# WMI_SUBSCRIPTION_PERSIST — golden replay datasets

`WMI event subscription trifecta: event filter creation + consumer binding — fileless persistence surviving reboot without scheduled task or registry run key (T1546.003)`
