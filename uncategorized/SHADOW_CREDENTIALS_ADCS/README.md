# SHADOW_CREDENTIALS_ADCS — golden replay datasets

`ADCS certificate-based attack — enumeration or ESC exploitation, cert request, certificate-based auth for lateral movement or persistence (T1649)`
