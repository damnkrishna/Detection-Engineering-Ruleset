# STAGED_CLOUD_UPLOAD — golden replay datasets

`File collection on endpoint (HIDS) followed by cloud sync client making large outbound upload (Zeek) — T1567.002 exfil over cloud storage API evading DLP; cross-sensor confirmation`
