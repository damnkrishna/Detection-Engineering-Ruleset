# ASREP_ROASTING — golden replay datasets

`AS-REP roasting: pre-auth disabled on account + TGT requested without pre-auth — offline hash cracking vector (T1558.004)`
