# NETWORK_TUNNEL_COVERT — golden replay datasets

`Covert channel: protocol tunneling (DNS/ICMP/HTTP) or port forwarding tool — C2 traffic hiding inside legitimate protocols (T1572, T1090)`
...
| `true_positive_1.jsonl` | 1 | SEQUENCE: stage 0 × 1 event(s) → stage 1 × 2 event(s) |
| `true_positive_2.jsonl` | 1 | SEQUENCE: stage 0 × 1 event(s) → stage 1 × 2 event(s) |
