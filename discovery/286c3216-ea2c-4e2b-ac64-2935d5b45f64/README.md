# 286c3216-ea2c-4e2b-ac64-2935d5b45f64 — golden replay datasets

`Backup Software Discovery via PowerShell Script Block (AN0240-B)`
...
| `benign_1.jsonl` | 0 | near-miss value for 'script_block_text contains Veeam' — every other condition holds, so the stage gate rejects the events |
