# 360fdc81-c1b7-440a-8f86-db3e7218c92a — golden replay datasets

`DHCP Spoofing Tool Execution (AN1290-A)`
...
| `benign_2.jsonl` | 0 | near-miss value for 'image_path regex .*\Q\yersinia.exe\E$' — every other condition holds, so the stage gate rejects the events |
