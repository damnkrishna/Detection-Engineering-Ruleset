# 4bfe6f18-0d3e-4873-8abf-2cb7107ef6c4 — golden replay datasets

`Logon Process Memory Access (AN0389-A)`
...
| `benign_2.jsonl` | 0 | near-miss value for 'target_image regex .*\Q\logonui.exe\E$' — every other condition holds, so the stage gate rejects the events |
