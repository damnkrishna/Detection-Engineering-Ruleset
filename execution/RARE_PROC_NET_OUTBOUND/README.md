# RARE_PROC_NET_OUTBOUND — golden replay datasets

`Non-browser signed-binary process makes first-ever outbound connection on non-standard port — implant or LOLBin C2 first-time activation (T1071, T1095)`
