# AN0577 — golden replay datasets

`Execution of Legitimate Binary from Suspicious Directory (AN0577)`
...
| `benign_1.jsonl` | 0 | near-miss value for 'cmd_line contains C:\Windows\' — every other condition holds, so the stage gate rejects the events |
