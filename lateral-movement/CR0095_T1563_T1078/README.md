# CR0095_T1563_T1078 — golden replay datasets

`Administrative RDP Session Hijacking via tscon.exe`
...
| `benign_1.jsonl` | 0 | near-miss value for 'signature_name contains RDP connection' — every other condition holds, so the stage gate rejects the events |
