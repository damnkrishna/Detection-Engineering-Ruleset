# CR0096_T1021_T1547 — golden replay datasets

`Remote Registry Modification for Auto-Run Persistence`
...
| `benign_1.jsonl` | 0 | near-miss value for 'signature_name contains Remote Registry access' — every other condition holds, so the stage gate rejects the events |
