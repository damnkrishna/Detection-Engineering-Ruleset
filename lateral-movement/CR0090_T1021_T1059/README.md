# CR0090_T1021_T1059 — golden replay datasets

`WinRM Remote Command Execution followed by Process Spawn`
...
| `benign_1.jsonl` | 0 | near-miss value for 'signature_name contains WinRM traffic' — every other condition holds, so the stage gate rejects the events |
